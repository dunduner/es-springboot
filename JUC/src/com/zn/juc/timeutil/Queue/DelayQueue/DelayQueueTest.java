package com.zn.juc.timeutil.Queue.DelayQueue;
...
public class DelayQueueTest {
    public static void main(String[] args) throws Exception {
        ...
        queue.add(new Member("张三", 5, TimeUnit.SECONDS));
        queue.add(new Member("李四", 8, TimeUnit.SECONDS));
        // 如果聚会还有人在呢
        while (!queue.isEmpty()) {
            // 从里面取出数据内容
...
class Member implements Delayed {
    ...
    public Member(String name, long delay, TimeUnit unit) {
        this.name = name;
        // 保存延迟的时间
        this.delay = TimeUnit.MILLISECONDS.convert(delay, unit);//讲3转为3000
        // 当前时间加上延迟时间
...
//        int num = (int) (this.delay-this.getDelay(TimeUnit.MILLISECONDS));
//        System.out.println(num);
    ...
    public String toString() {
        return this.name + "预计" + this.delay + "毫秒后离开，现在已经到点了。";
    }
}